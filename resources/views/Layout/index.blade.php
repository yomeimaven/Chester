                    ...
                    <div class="modal-body">
                        <form action="{{route('ChangePassword')}}" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <input type="password" id="Current" onchange="checkPassword()" name="Current" class="form-control" placeholder="Enter Current Password" required>
                          ...
                          <div class="form-group">
                              ...
                              <input id="Cpassword" type="password" onchange="confirmPassword()" name="Cpassword" class="form-control" placeholder="Enter New Password" required>
