...
Route::get('ForgotPasswordview', [ViewController::class, 'ForgotPasswordview'])->name('ForgotPasswordview');
Route::get('sendOtp', [AjaxController::class, 'sendOtp'])->name('sendOtp');
Route::post('CreateNewPassView', [ViewController::class, 'CreateNewPassView'])->name('CreateNewPassView');
Route::post('UpdateNewPassword', [AccountController::class, 'UpdateNewPassword'])->name('UpdateNewPassword');
